...
class Agent(Thing):
    ...
    """Un Agente es una subclase de Cosa con un atributo de instancia requerido (tambien conocido como slot), .program, que debe contener una función que toma un argumento, el percepto, y devuelve una acción. (Lo que cuente como percepto o acción dependerá del entorno específico en el que exista el agente).     Nótese que 'program' es una ranura, no un método. Si fuera un método, el programa podría hacer "trampas" y ver aspectos del agente. Se supone que no puede hacer eso: el programa sólo puede mirar los perceptos. Un programa agente que necesite un modelo del mundo (y del propio agente) tendrá que construir y mantener su propio modelo. Hay una ranura opcional, .performance, que es un número que da la medida del rendimiento del agente en su entorno"""
...
def RandomAgentProgram(actions):
    ...
    True
    """
    eleccion=random.choice(actions)
    return lambda percept: eleccion#al usar lambda es como crear una funcion
...
class Environment:
    ...
    def step(self):
        ...
        if not self.is_done():
            ...
            #print('======')#ultimo
            print('Accion tomada: ', actions)#ultimo
...
class TrivialVacuumEnvironment(Environment):
    ...
    def __init__(self):
        super().__init__()#para llamar los atributos de Environment
